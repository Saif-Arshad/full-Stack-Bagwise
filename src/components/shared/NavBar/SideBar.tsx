...
return (
  <>
    ...
    <button onClick={toggleSidebar} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className=" fixed z-30 inline-flex items-start  p-2 mt-2 ms-3 text-sm text-gray-500  rounded-lg sm:hidden h-9 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 ">
    ...
    <aside id="default-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform ${sidebarOpen ? '' : '-translate-x-full'} sm:translate-x-0`} aria-label="Sidebar">
      ...
      <Link href="/" >
        <span className="self-center ml-2 py-4 flex items-center text-2xl font-bold whitespace-nowrap ">
        <div >
